<?php 
	...
	$db = mysqli_connect(MYSQLI_HOST, MYSQLI_USER, MYSQLI_PASSWORD) or die ('Unable connect, Please check your connection parameters.');
	mysqli_select_db($db, MYSQLI_DB) or die (mysqli_error($db));

	if(isset($_POST['submit']) && $_POST['submit'] == 'Yes'){
		$query = 'DELETE i FROM site_user u JOIN site_user_info i ON u.user_id = i.site_user_info WHERE username = "' . mysqli_real_escape_string($db, $_SESSION['username']) . '"';
